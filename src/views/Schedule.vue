<template>
    <div class="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div class="relative h-[800px] -mt-28 mb-20 overflow-hidden">
            <video autoplay muted loop playsinline class="absolute inset-0 w-full h-full object-cover z-0">
                <source src="/videos/bg.mp4" type="video/mp4" />
            </video>
            <div class="relative z-10 h-full py-16 px-4 sm:px-6 lg:px-8 mt-16">
                <h1 class="text-[40px] text-center font-medium font-sans leading-tight lg:mb-40 mb-48"
                    v-motion-slide-visible-once-left :delay="300">
                    Schedule your call
                </h1>
